...
<div class="modal fade" id="exampleModal4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Elimina una marca </h5>
  ...
  <div class="col-md-7 position-relative">
    ...
    <input type="text" class="form-control" name="name" value="{{ $brand->name }}" id="validationTooltip01"  disabled>
  ...
  <div class="col-12">
    <button class="btn btn-primary" type="submit"> Eliminar Marca </button>
  </div>
</form>
