...
<div class="modal fade" id="exampleModal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Elimina los modelos</h5>
  ...
  <div class="col-md-4 position-relative">
    ...
    <input type="text" class="form-control" value="{{ $model->name }}" name="name" id="validationTooltip01" disabled>
  ...
  <div class="col-md-4 position-relative">
    ...
    <select class="form-select" name="brand_id" id="validationTooltip02" disabled>
  ...
  <div class="col-12">
    <button class="btn btn-primary" type="submit"> Eliminar Modelo </button>
  </div>
</form>
